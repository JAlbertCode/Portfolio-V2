        ...
        <main className="flex min-h-screen flex-col items-center pt-5">      
            ...
            <div className="mx-4 max-w-5xl">
                ...
                <div className="w-4/5 mx-auto my-10">
                    ...
                    <p>For the final project at Fullstack Academy, we were split into teams of four and given two and a half weeks to define and develop a project. Everyone in our group was a fan of tabletop games, and we decided to give new life to an old concept. The game we settled on was Werewolf. Werewolf is a social deduction game where some players are on the "bad" team and others are on the "good" team, but neither player knows the other's identity. Throughout the game, players vote to kill each other based on their suspicions, and the last team standing wins the game. Our team put a new spin on the game by allowing groups to form in online video conferences and by programmatically managing all of the events in the game.
                    </p>
                    <h2>Gameplay Demo</h2>
