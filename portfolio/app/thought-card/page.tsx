        ...
        <main className="flex min-h-screen flex-col items-center pt-5">      
            ...
            <div className="mx-4 max-w-5xl">
                ...
                <div className="w-4/5 mx-auto my-10">
                    ...
                    <p>After sharing some augmented reality ideas with a friend, he requested that I augment his business card. Over several years, he compiled quotes that he felt moved by and wanted to share the quotes with the people who had his business card. He called the idea a &ldquo;Thought Card&rdquo;.
                    <br/><br/>
