        ...
        <main className="flex min-h-screen flex-col items-center pt-5">      
            ...
            <div className="mx-4 max-w-5xl">
                ...
                <div className="w-4/5 mx-auto my-10">
                    ...
                    <br/><br/>
                    While Token Sets is an incredible tool, ultimately I was unsure of the legal implications and did not want to take the leap of being responsible for the funds of family and friends. Luckily I did not move forward because LUNA imloded months after. 
                    </p>
                    <div className="links">
                    ...
                    <p>In late 2022, I was searching for my next role and applied to a firm that creates Crypto indexes for ETF issuers. The firm asked me to put together an index and I chose to create an index for Smart Contracts. I provided the document below and it lead me to the next round of the interview process. I was in the last rounds of interviewing for a few different companies and decided to accept an offer at another organization instead of continuing the interview process. Below is the strategy, and my rationalization for investing in a Smart Contract Index.</p>
                    <br/>
