        ...
        <main className="flex min-h-screen flex-col items-center pt-5">      
            ...
            <div className="mx-4 max-w-5xl">
                ...
                <div className="w-4/5 mx-auto my-10">
                    <h1>Grace Potter</h1>
                    <p>During the senior phase of Fullstack Academy, three other students and I were tasked with developing an e-commerce platform. One of our team members made pottery in his free time, and we decided to build a platform to sell the products he made.
                    </p>
                    <div className="links">
