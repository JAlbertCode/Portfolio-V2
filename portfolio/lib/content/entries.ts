...
export const entries: Entry[] = [
  ...
  },
  {
    ...
    cover: { src: '/images/lilypad-iotex-pitch.jpg', alt: 'Lilypad pitch for the IoTeX competition' },
  ...
  },
  {
    ...
    cover: { src: '/images/rag-agents-on-lilypad.jpg', alt: 'Building RAG agents on Lilypad' },
  ...
  },
  {
    ...
    domains: ['AI', 'Blockchain & Web3'],
    cover: { src: '/images/lilypad-cryptos-got-talent.jpg', alt: 'Lilypad at Crypto\'s Got Talent' },
  ...
  },
  {
    ...
    cover: { src: '/images/lilypad-frontend-workshop.jpg', alt: 'Lilypad frontend workshop' },
  ...
  },
  {
    ...
    practices: ['Developer Relations'],
    domains: ['Blockchain & Web3', 'Developer Tools'],
    cover: { src: '/images/fireside-2026-03-04.jpg', alt: 'Fireside Dev Hang: Tutorials, Tooling & Community Updates' },
  ...
  },
  {
    ...
    cover: { src: '/images/fireside-2026-02-04.jpg', alt: 'Fireside Dev Hang: Global Game Jam highlights, community updates and more' },
  ...
  },
  {
    ...
    practices: ['Developer Relations'],
    domains: ['Blockchain & Web3', 'Gaming'],
    cover: { src: '/images/fireside-2026-01-28.jpg', alt: 'Fireside Dev Hang: Contributor Hub highlights, Validator updates and Game Jam' },
  ...
  },
  {
    ...
    practices: ['Developer Relations'],
    domains: ['Blockchain & Web3'],
    cover: { src: '/images/hilo-hack-demo-day.jpg', alt: 'Hilo Hack Demo Day' },
  ...
  // titles.
  {
    ...
    domains: ['Blockchain & Web3', 'Gaming'],
    cover: { src: '/images/mlh-midnight-july-hack-winners.jpg', alt: 'Celebrating seven winners from the MLH x Midnight July hack' },
  ...
  },
  {
    ...
    practices: ['Writing & Research', 'Developer Relations'],
    domains: ['Blockchain & Web3', 'Developer Tools'],
    cover: { src: '/images/midnight-improvement-proposal-process.jpg', alt: 'The Midnight Improvement Proposal Process' },
  ...
  },
  {
    ...
    practices: ['Writing & Research', 'Developer Relations'],
    domains: ['Blockchain & Web3', 'Developer Tools'],
    cover: { src: '/images/night-and-dust-for-developers.png', alt: 'The implications of NIGHT and DUST for developers' },
  ...
  // would be exactly the failure mode this file exists to prevent.
  {
    ...
    cover: { src: '/images/example-mip-0014.png', alt: 'MIP-0014 reference implementation' },
  ...
  },
  {
    ...
    domains: ['Blockchain & Web3', 'Developer Tools'],
    tech: ['TypeScript', 'Compact'],
    cover: { src: '/images/example-locker.png', alt: 'Locker rental example' },
  ...
  },
  {
    ...
    domains: ['Blockchain & Web3'],
    tech: ['TypeScript', 'Compact'],
    cover: { src: '/images/midnight-tip-jar.png', alt: 'Midnight Tip Jar' },
  ...
  },
  {
    ...
    practices: ['Writing & Research', 'Developer Relations'],
    domains: ['Blockchain & Web3', 'Developer Tools'],
    cover: { src: '/images/partner-sprints-on-midnight.jpg', alt: 'The ecosystem icon from the Midnight blog banner set, the image this post publishes' },
  ...
  },
  {
    ...
    domains: ['Blockchain & Web3', 'Developer Tools'],
    cover: { src: '/images/hacktoberfest-contributor-guide.jpg', alt: 'The hackathons icon from the Midnight blog banner set' },
